...
class ToDoListState extends State {
  ...
  void showBottomPopupMessage(BuildContext context, String message) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        backgroundColor: const Color.fromARGB(255, 127, 148, 206),
  ...
  bool validateContactNumber(String number) {
    // Regular expression for validating 10-digit mobile numbers
                      ...
                      children: [
                        Text("Enter Personal Details",
                            style: TextStyle(
                              ...
                              decorationColor: Color.fromARGB(255, 14, 14, 14),
